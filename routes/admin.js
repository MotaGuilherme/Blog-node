    ...
    if(erros.length > 0){
        ...
        const novaCategoria = {
            ...
            new Categoria(novaCategoria).save().then(() => {
                ...
                req.flash("error_msg", "Hove um erro ao salvar aa categoria, tente novamente!")
                res.redirect("/admin")
            })
...
router.get("/categorias/edit/:id", eAdmin, (req, res) => {
    Categoria.findOne({_id: req.params.id}).then((categoria) => {
        ...
        req.flash("error_msg","esta categoria nao exoste")
...
router.get("/postagens", eAdmin, (req, res) => {
    ...
    Postagem.find().lean().populate("categoria").sort({data: "desc"}).then((postagens) => {
        ...
        req.flash("error_msg", "Houve um erro ao listar as postgens")
        res.redirect("/admin")
    })
...
router.get("/postagens/edit/:id", eAdmin, (req, res) => {
    ...
    Postagem.findOne({_id: req.params.id}).lean().then((postagem) =>  {
        Categoria.find().lean().then((categorias) => {
            ...
            req.flash("error_msg", "Houve um erro ao mostar as categorias")
            res.redirect("/admin/postagens")
        })
